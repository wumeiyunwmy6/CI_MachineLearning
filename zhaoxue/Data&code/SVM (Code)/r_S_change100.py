...
pd.DataFrame(accuracy_list).to_csv('E:\\zhaoxue(last-first)_2\\activity_plus\\classification\\r_S_change(acc100).csv')
pd.DataFrame(precision_list).to_csv('E:\\zhaoxue(last-first)_2\\activity_plus\\classification\\r_S_change(pre100).csv')
pd.DataFrame(recall_list).to_csv('E:\\zhaoxue(last-first)_2\\activity_plus\\classification\\r_S_change(rec100).csv')
pd.DataFrame(auc_list).to_csv('E:\\zhaoxue(last-first)_2\\activity_plus\\classification\\r_S_change(auc100).csv')